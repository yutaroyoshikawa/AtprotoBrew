...
function BrewIcon() {
	return (
		<div className="relative w-14 h-14 mx-auto mb-2 drop-shadow-lg">
			...
			>
				<svg viewBox="0 0 36 36" fill="none" className="w-9 h-9" aria-hidden="true">
					<rect x="5" y="14" width="20" height="15" rx="3" fill="white" fillOpacity="0.9" />
					<path
					...
					<path
						...
						strokeOpacity="0.85"
					/>
					<rect x="9" y="29" width="16" height="2" rx="1" fill="white" fillOpacity="0.5" />
				</svg>
			</div>
...
export function ChannelTile(props: ChannelTileProps) {
	...
	return (
		...
		>
			...
			<div className="absolute bottom-0 left-0 right-0 h-1 opacity-70" style={{ background: channel.color }} />
		</button>
	);
}
