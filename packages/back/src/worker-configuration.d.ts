/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings ./src/worker-configuration.d.ts` (hash: ecff494d7bea885cb724b91d830b738a)
// Runtime types generated with workerd@1.20260410.1 2026-04-18 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		DB: D1Database;
		AIRGLOW_SECRETS: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AIRGLOW_SECRETS">> {}
}
